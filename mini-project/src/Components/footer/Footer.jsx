        ...
        <Flex justifyContent={"space-between"} mt={"20px"} ml={"55px"}>
                  ...
                  <Box w="40px" h="40px">
                    ...
                    >
                      <Image
                        width="10"
                        height="10"
                        src="https://img.icons8.com/fluency/100/instagram-new.png"
                        alt="instagram-new"
                      />
                    </Link>
                  </Box>
                  <Box w="40px" h="40px">
                    ...
                    >
                      <Image
                        width="10"
                        height="10"
                        src="https://img.icons8.com/fluency/100/linkedin.png"
                        alt="linkedin"
                      />
                    </Link>
                  </Box>
                  <Box w="40px" h="40px">
                    ...
                    >
                      <Image
                        width="10"
                        height="10"
                        src="https://img.icons8.com/sf-black-filled/100/github.png"
                        alt="github"
                      />
                    </Link>
                  </Box>
          ...
          <Box mt={"20px"} color={"#E7CEA6"}>
            ...
            <Text
              ...
              fontFamily={"serif"}
            >
              A quick morning email to help you start each day on the right
              foot.
            </Text>
            <Stack>
              <Input
