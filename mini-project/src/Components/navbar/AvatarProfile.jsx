...
export default function AvatarProfile(){
    ...
    <MenuList w={'300px'} marginRight={'10px'}>
        ...
        <Center>
        <Button colorScheme='whatsapp' w={'200px'} h={'30px'} borderRadius={'50px'} mt={'20px'} onClick={toSignUp}>Sign up</Button>
        </Center>
        <Center>
        <Button border={'1px'} borderColor={'black'} w={'200px'} h={'30px'} borderRadius={'50px'} mt={'20px'} onClick={toSigninPage}>Sign in</Button>
        </Center>
